...
echo "<div class='col-3 nav flex-column nav-pills me-3' id='v-pills-tab' role='tablist' aria-orientation='vertical'>";
    ...
    echo "' href='/selflearn.com/profile' role='tab' aria-controls='v-pills-myProfile' aria-selected='false'>My Profile</a>";
    ...
    echo "' href='/selflearn.com/paymentstatus' role='tab' aria-controls='v-pills-paymentStatus' aria-selected='true'>Payment Status</a>";
