...
echo "<div class='container-fluid text-center py-2'>
    <div class='row'>
        <div class='col-2 border border-left-0 border-top-0 border-bottom-0 border-dark'>
            <a href='/selflearn.com/' type='button' class='text-decoration-none'>Home</a><br>
            <a href='/selflearn.com/courses' type='button' class='text-decoration-none'>All Courses</a><br>
            <a href='/selflearn.com/aboutus' type='button' class='text-decoration-none'>About Us</a><br>";
            if ($loggedin) {
                
                echo "<a href='/selflearn.com/profile' type='button' class='text-decoration-none'>My Profile</a><br>";
                echo "<a href='/selflearn.com/mycourses' type='button' class='text-decoration-none'>My Courses</a>";
            }
            
        echo "</div>
    <div class='col-7'>
        <br><p>Confused on which course to take? We have got you covered. Browse courses and find out the best course for
        ...
        <div class='col-3 border border-right-0 border-top-0 border-bottom-0 border-dark'>";
...
if ($result) {
    ...
    for ($i=1; $i <= 5 && $row = mysqli_fetch_assoc($result) ; $i++) { 
        ...
        echo "<a href='/selflearn.com/courseDetails?courseID=$courseID' type='button' class='text-decoration-none'>$courseTitle</a><br>";
    }
}
