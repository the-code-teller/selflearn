...
echo "<div class='col-3 nav flex-column nav-pills me-3' id='v-pills-tab' role='tablist' aria-orientation='vertical'>";
    ...
    echo "<div class='border-0 my-2' style='width: 10rem;'>
        <img src='/selflearn/img/$studentDP' class='img-thumbnail m-5 mt-5' alt='...' width='100px' height='100px'>
    </div>";
    ...
    echo "' href='/selflearn/profile' role='tab' aria-controls='v-pills-myProfile' aria-selected='true'>My Profile</a>";
    ...
    echo "' href='/selflearn/paymentstatus' role='tab' aria-controls='v-pills-paymentStatus' aria-selected='false'>Payment Status</a>";
